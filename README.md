...
3. **Time series extraction** - using Principal Component Analysis, we exctract the time series *s<sub>i</sub>* from the snapshots as described in our article, Appendix, section 2.
