...
Graph Graph::longTermSubgraph(int minimalRepresentativeAddressesNumber, int minimalIntervalInDays, int minimalTransactionsNumber, string usersGraphPath, string contractedAddressesPath)
{
	...
	// Determine activity period for and transactions number for each user
	...
	return Graph(V, E, transactionsNumber = transactionsNumber, usersNumber = maxUserId);
}
